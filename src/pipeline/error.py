...
pharo_errors_path = os.path.abspath(user_home_dir + '/Documents/Pharo/images/Moose Suite 10 (stable)/pharoError.csv')
...
def merge_error_files(pharo_error_file, ts2famix_error_file, nestProjects, loopbackProjects, merged_error_file):
    ...
    pharo_errors = {}
    if os.path.exists(pharo_error_file):
    ...
    ts2famix_errors = {}
    if os.path.exists(ts2famix_error_file):
